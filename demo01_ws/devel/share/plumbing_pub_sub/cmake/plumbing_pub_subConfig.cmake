...
if("TRUE" STREQUAL "TRUE")
  set(plumbing_pub_sub_SOURCE_PREFIX /home/vol/willgit/demo01_ws/src/plumbing_pub_sub)
  set(plumbing_pub_sub_DEVEL_PREFIX /home/vol/willgit/demo01_ws/devel)
  ...
  set(plumbing_pub_sub_INSTALL_PREFIX /home/vol/willgit/demo01_ws/install)
...
if(NOT "/home/vol/willgit/demo01_ws/devel/include " STREQUAL " ")
  set(plumbing_pub_sub_INCLUDE_DIRS "")
  set(_include_dirs "/home/vol/willgit/demo01_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'vol <vol@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plumbing_pub_sub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vol/willgit/demo01_ws/src/plumbing_pub_sub/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vol/willgit/demo01_ws/devel/lib;/opt/ros/noetic/lib)
